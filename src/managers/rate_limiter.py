...
files in the current run), so --rate-limit caps the total bandwidth used by the process,
not a per-connection or per-file limit that would be trivially multiplied by
